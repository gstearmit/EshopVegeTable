...
-- Dumping structure for table rohlik99_apotraviny.declaration
CREATE TABLE IF NOT EXISTS `declaration` (
  ...
  `product_promotion` int(100) DEFAULT NULL,
  `product_href_detail` text,
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='declaration -- mau de loc du lieu';

-- Dumping data for table rohlik99_apotraviny.declaration: ~4 rows (approximately)
/*!40000 ALTER TABLE `declaration` DISABLE KEYS */;
INSERT INTO `declaration` (`id`, `product_code`, `name_id`, `host`, `url`, `page_taken`, `avatar_images`, `directoryavatar`, `product_name`, `product_price`, `product_images`, `product_descriptstion`, `detail_product_descriptstion`, `product_promotion`, `product_href_detail`) VALUES
	(5, 1915, 2, 'https://www.rohlik.cz', 'https://www.rohlik.cz/c75533-napoje', 12, NULL, 'upload', 'div.items article h3', 'div.items article h6', 'img.grocery-image-placeholder', NULL, NULL, 0, 'div.items article h3'),
	(6, 1487, 3, 'https://www.rohlik.cz', 'https://www.rohlik.cz/c133337-alkohol-a-tabak', 12, NULL, 'upload', 'div.items article h3', 'div.items article h6', 'div.items article a.img img', NULL, NULL, 0, 'div.items article h3'),
	(14, 698789, 3, 'https://www.rohlik.cz/hotxvxcvxcvc', 'https://www.rohlik.cz/c133337-alkohol-a-tabak/jotxcvxcv', 2132, NULL, NULL, 'div.items article h3', 'div.items article h6', 'div.items article a.img img', NULL, NULL, 123, 'div.items article h3');
/*!40000 ALTER TABLE `declaration` ENABLE KEYS */;


-- Dumping structure for table rohlik99_apotraviny.declaration_detail
...
-- Dumping data for table rohlik99_apotraviny.declaration_detail: ~0 rows (approximately)
...
-- Dumping structure for table rohlik99_apotraviny.name
...
-- Dumping data for table rohlik99_apotraviny.name: ~11 rows (approximately)
...
-- Dumping data for table rohlik99_apotraviny.payoutrates: ~155 rows (approximately)
...
-- Dumping data for table rohlik99_apotraviny.product: ~29 rows (approximately)
...
INSERT INTO `product` (`id`, `name`, `alias`, `descripts`, `detail_product`, `cat_id`, `new`, `hot`, `promotions`, `price`, `rating`, `availability`, `tag_id`, `manufacturer_id`, `date_creat`, `date_change`, `user_id`, `status`, `about_price`, `weekly_featured`, `featured_products`, `new_products`, `sale_products`, `most_viewed`, `lastest_products`, `array_img`, `img`, `img0`, `img1`, `img2`, `img3`, `img4`, `img5`, `img6`, `img7`, `img8`, `img9`) VALUES
	...
	(58, 'Hoang Phuc Test', NULL, NULL, '2121', 1, 1, 1, 123, NULL, NULL, 123, 10, NULL, '2015-06-08', '2015-06-08', NULL, 1, 0, 1, 1, 1, 1, NULL, NULL, NULL, 'thumb_1433762964.jpg', NULL, 'thumb_1433762964.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(60, 'test product', NULL, NULL, 'dsfds', 2, 1, 1, 1234, NULL, NULL, 123, NULL, NULL, '2015-06-10', '2015-06-10', NULL, 0, 123, 1, 1, 1, 1, NULL, NULL, NULL, 'thumb_1433924976.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(61, 'test product new', 'test-product-new', 'alias', 'alias', 2, 1, 1, 120, 130, NULL, 124, 10, NULL, '2015-06-12', '2015-06-12', NULL, 1, 120, 1, 1, 1, 1, NULL, NULL, NULL, 'thumb_1434090256.jpg', NULL, 'thumb_1434090256.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
