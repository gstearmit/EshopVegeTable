...
-- Dumping data for table rohlikcz.name: ~9 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `newsletter` (
  ...
  `status` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='newsletter';
...
INSERT INTO `newsletter` (`id`, `date_creat`, `id_user`, `is_subscribed`, `email`, `status`) VALUES
	...
	(10, '2015-06-19', NULL, 1, 'gstearmit789@gmail.com', '1');
...
-- Dumping data for table rohlikcz.payoutrates: ~155 rows (approximately)
...
-- Dumping data for table rohlikcz.product: ~27 rows (approximately)
