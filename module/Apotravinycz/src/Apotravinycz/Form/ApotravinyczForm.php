<?php
namespace Apotravinycz\Form;
use Apotravinycz\Controller\IndexController;
...
class ApotravinyczForm extends Form
{
    ...
    public function addElements()
    {
    	...
    	$name->setLabel('Apotravinycz name')
    	->setAttribute('class','form-control')
    	->setAttribute('required','true')
    	...
    	$alias->setLabel('Apotravinycz alias')
    	->setAttribute('required','true')
    	->setAttribute('class','form-control')
    	...
    	$description->setLabel('Detail Apotravinycz')
    	->setAttribute('class','form-control')
    	...
    	$featured_products->setLabel('Featured Apotravinyczs')
    	//->setAttribute('required','true')
    	->setValueOptions(
    			array(
    					'0' => 'No',
    	...
    	$new_products->setLabel('New Apotravinyczs')
    	//->setAttribute('required','true')
    	->setValueOptions(
    			array(
    					'0' => 'No',
    	...
    	$sale_products->setLabel('Sale Apotravinyczs')
    	//->setAttribute('required','true')
    	->setValueOptions(
    			array(
    					'0' => 'No',
