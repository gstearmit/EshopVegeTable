...
class CrowlerForm extends Form {
...
//        //-----------------------------------------------------
        ...
        $featured_products->setLabel('Featured Products')
                //->setAttribute('required','true')
                ->setValueOptions(
                        array(
                            '0' => 'No',
        ...
        $new_products->setLabel('New Products')
                //->setAttribute('required','true')
                ->setValueOptions(
                        array(
                            '0' => 'No',
        ...
        $sale_products->setLabel('Sale Products')
                //->setAttribute('required','true')
                ->setValueOptions(
                        array(
                            '0' => 'No',
    ...
    public function addElements() {
        ...
        $description->setLabel('Detail Product')
                ->setAttribute('class', 'form-control')
