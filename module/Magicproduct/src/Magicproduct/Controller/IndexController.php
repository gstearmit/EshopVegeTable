...
// 	  	}
	  	//Product
	  	$limit_NEW_PRODUCTS = null;
	  	$Product_NEW_PRODUCTS = $this->getServiceLocator()->get('ProductTable')->get_NEW_PRODUCTS($limit_NEW_PRODUCTS);
	  
	  	$viewModel->Product_NEW_PRODUCTS = $Product_NEW_PRODUCTS;
	  	return $viewModel;
	  }
