...
class BuyerTable {
	...
	public function save(Buyer $news) {
		$data = array (
				'BuyerName' => $news->BuyerName,
				'BuyerEmail' => $news->BuyerEmail,
				'ItemName' => $news->ItemName,
			
				'ItemNumber' => $news->ItemNumber,
				'ItemAmount' => $news->ItemAmount,
				'ItemQTY' => $news->ItemQTY,
