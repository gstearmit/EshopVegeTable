...
class SlideTable {
 ...
 public function update_Status(Slide $Slide) {
    ...
    public function add_slide(Slide $Slide) {
    	//print_r($Slide);die;
    	$data = array(
    			'img' => $Slide ->img,
    			'text' => $Slide ->text,
    ...
    public function update_slide(Slide $Slide) {
    	$id = $Slide->id;
    	$data = array(
    			'img' => $Slide ->img,
    			'text' => $Slide ->text,
    ...
    public function fetch_slideshow(Select $select = null) {
    	if (null === $select){
