...
class StaticLink extends AbstractHelper {
	 ...
	 *        	Optional. The name of the subfolder to use. Should usually be one of the defined constants.
	 * @param array $subdirectories
	 *        	An array of subdirectories to append after the subfolder (which comes after the host). Should contain only strings.
	 */
	...
	//	$static_url = 'http://' . self::SUBDOMAIN . '.' . $this->request->getUri ()->getHost () . '/';
		$static_url = 'http://'. $this->request->getUri ()->getHost () . ':20135/';
