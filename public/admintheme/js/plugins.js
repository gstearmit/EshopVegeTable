...
function actiondelate(key){
    var url= $('#url-action').val()+key;
    var btn_del='<a href="'+url+'" class="waves-effect waves-green btn-flat modal-action modal-close">Yes</a>';
    $('.append-btn').html(btn_del);
    }