/*! jQuery v1.11.1 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license jquery-combined */ ! function(a, b) {
...
(function(e) {
    ...
    e.extend(a.prototype, {
        ...
        _generateHTML: function(e) {
            var t, i, s, a, n, o, r, h, l, u, d, c, p, f, m, g, v, y, b, _, x, w, k, T, D, S, N, M, C, A, P, I, H, z, F, E, W, L, j, O = new Date,
            ...
            for (e.drawMonth = Z, e.drawYear = et, i = this._get(e, "prevText"), i = K ? this.formatDate(i, this._daylightSavingAdjust(new Date(et, Z - q, 1)), this._getFormatConfig(e)) : i, s = this._canAdjustMonth(e, -1, et, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>", a = this._get(e, "nextText"), a = K ? this.formatDate(a, this._daylightSavingAdjust(new Date(et, Z + q, 1)), this._getFormatConfig(e)) : a, n = this._canAdjustMonth(e, 1, et, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + a + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + a + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + a + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + a + "</span></a>", o = this._get(e, "currentText"), r = this._get(e, "gotoCurrent") && e.currentDay ? X : R, o = K ? this.formatDate(o, r, this._getFormatConfig(e)) : o, h = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", l = J ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (Y ? h : "") + (this._isInRange(e, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>" : "") + (Y ? "" : h) + "</div>" : "", u = parseInt(this._get(e, "firstDay"), 10), u = isNaN(u) ? 0 : u, d = this._get(e, "showWeek"), c = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), f = this._get(e, "monthNames"), m = this._get(e, "monthNamesShort"), g = this._get(e, "beforeShowDay"), v = this._get(e, "showOtherMonths"), y = this._get(e, "selectOtherMonths"), b = this._getDefaultDate(e), _ = "", w = 0; V[0] > w; w++) {
                for (k = "", this.maxRows = 4, T = 0; V[1] > T; T++) {
                    ...
                    for (N += M + "</tr></thead><tbody>", A = this._getDaysInMonth(et, Z), et === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, A)), P = (this._getFirstDayOfMonth(et, Z) - u + 7) % 7, I = Math.ceil((P + A) / 7), H = G ? this.maxRows > I ? this.maxRows : I : I, this.maxRows = H, z = this._daylightSavingAdjust(new Date(et, Z, 1 - P)), F = 0; H > F; F++) {
                        for (N += "<tr>", E = d ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(z) + "</td>" : "", x = 0; 7 > x; x++) W = g ? g.apply(e.input ? e.input[0] : null, [z]) : [!0, ""], L = z.getMonth() !== Z, j = L && !y || !W[0] || Q && Q > z || $ && z > $, E += "<td class='" + ((x + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (L ? " ui-datepicker-other-month" : "") + (z.getTime() === D.getTime() && Z === e.selectedMonth && e._keyEvent || b.getTime() === z.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (j ? " " + this._unselectableClass + " ui-state-disabled" : "") + (L && !v ? "" : " " + W[1] + (z.getTime() === X.getTime() ? " " + this._currentClass : "") + (z.getTime() === R.getTime() ? " ui-datepicker-today" : "")) + "'" + (L && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (j ? "" : " data-handler='selectDay' data-event='click' data-month='" + z.getMonth() + "' data-year='" + z.getFullYear() + "'") + ">" + (L && !v ? "&#xa0;" : j ? "<span class='ui-state-default'>" + z.getDate() + "</span>" : "<a class='ui-state-default" + (z.getTime() === R.getTime() ? " ui-state-highlight" : "") + (z.getTime() === X.getTime() ? " ui-state-active" : "") + (L ? " ui-priority-secondary" : "") + "' href='#'>" + z.getDate() + "</a>") + "</td>", z.setDate(z.getDate() + 1), z = this._daylightSavingAdjust(z);
                        N += E + "</tr>"
                    }
    ...
    }, e.datepicker = new a, e.datepicker.initialized = !1, e.datepicker.uuid = (new Date).getTime(), e.datepicker.version = "1.11.1", e.datepicker;
    var c = "ui-effects-",
        p = e;
    e.effects = {
            effect: {}
...
(function(d) {
    ...
    var m = /\+/g,
        f = d.cookie = function(b,
            ...
            a = b ? void 0 : {};
            for (var c = document.cookie ? document.cookie.split("; ") : [], g = 0, m = c.length; g < m; g++) {
                var h = c[g].split("="),
                    k;
                k = h.shift();
                k = f.raw ?
    ...
    d.removeCookie = function(b, e) {
        return void 0 !== d.cookie(b) ? (d.cookie(b, "", d.extend({}, e, {
            expires: -1
        })), !0) : !1
    }
});
...
! function(a, b, c) {
    ...
    d.prototype = {
        ...
        getTemplate: function() {
            var a, b, c, d, e, f;
            switch (this.showInputs ? (b = '<input type="text" class="bootstrap-timepicker-hour" maxlength="2"/>', c = '<input type="text" class="bootstrap-timepicker-minute" maxlength="2"/>', d = '<input type="text" class="bootstrap-timepicker-second" maxlength="2"/>', e = '<input type="text" class="bootstrap-timepicker-meridian" maxlength="2"/>') : (b = '<span class="bootstrap-timepicker-hour"></span>', c = '<span class="bootstrap-timepicker-minute"></span>', d = '<span class="bootstrap-timepicker-second"></span>', e = '<span class="bootstrap-timepicker-meridian"></span>'), f = '<table><tr><td><a href="#" data-action="incrementHour"><i class="glyphicon glyphglyphicon glyphicon-chevron-up"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><i class="glyphicon glyphicon-chevron-up"></i></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><i class="glyphicon glyphicon-chevron-up"></i></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" data-action="toggleMeridian"><i class="glyphicon glyphicon-chevron-up"></i></a></td>' : "") + "</tr>" + "<tr>" + "<td>" + b + "</td> " + '<td class="separator">:</td>' + "<td>" + c + "</td> " + (this.showSeconds ? '<td class="separator">:</td><td>' + d + "</td>" : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td>' + e + "</td>" : "") + "</tr>" + "<tr>" + '<td><a href="#" data-action="decrementHour"><i class="glyphicon glyphicon-chevron-down"></i></a></td>' + '<td class="separator"></td>' + '<td><a href="#" data-action="decrementMinute"><i class="glyphicon glyphicon-chevron-down"></i></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><i class="glyphicon glyphicon-chevron-down"></i></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><i class="glyphicon glyphicon-chevron-down"></i></a></td>' : "") + "</tr>" + "</table>", this.template) {
                case "modal":
...
function clone(a) {
    ...
    if (a instanceof Array) {
        for (var b = [], c = 0, d = a.length; c < d; c++) b[c] = clone(a[c]);
        return b
    }
...
$(document).ready(function() {
    ...
    $(window).on('resize', function() {
        var $over = $('.mainmenu > ul li').filter(function(i) {
            return $(this).position().top >= 43
        });
        var overHTML = '';
        $over.each(function() {
    ...
    if (document.getElementById('slider')) {
        $('#slider').sySlider(function($scroller, index) {
            ...
            if (top < 0) {
                ...
                $scroller.stop(true, true).animate({
                    scrollTop: $scroller.scrollTop() + (bottom - $scroller.height())
                }, 200);
            }
        });
    }
    ...
    if ($('[id^=visa-fee]').length > 0) {
        $('[id^=visa-fee] .apply-here').click(function(e) {
            ...
            $.cookie('apply_obj', JSON.stringify(obj), {
                path: '/'
            });
    ...
    if (document.getElementById('full-apply')) {
        ...
        var VisaModel = function() {
            ...
            $.get('/ajax.php?action=getServerTime', function(res) {
                self.today(new Date(res));
            });
            self.fromDate = new Date(2014, 11, 31, 18, 0, 0);
            self.toDate = new Date(2015, 0, 5, 0, 0, 0);
            ...
            self.invoice.service = ko.computed(function() {
                ...
                if (cond) {
                    ...
                    if (self.info.visa_type().substring(0, 1) == '1')
                        return +(242 * self.persons().length).toFixed(2);
            ...
            self.contact.primary_email.subscribe(function(newValue) {
                /*
		$.get(cf.domain+'ajax.php?action=getDiscountEmail&email='+self.contact.primary_email(), function(data) {
			if (data)
	...
	*/
            ...
            self.contact.promotion_code.subscribe(function(newValue) {
                console.log("id cha : " + self.contact.promotion_code());
                $.get(cf.domain + 'ajax.php?action=getDiscountCode&code=' + self.contact.promotion_code(), function(data) {
                    if (data)
            ...
            $.ajax({
                url: cf.domain + '/getServiceFee.json',
                type: 'get',
            ...
            self.apply = function() {
                $.cookie('number_visa', self.info.number_visa(), {
                    path: '/'
                });
                $.cookie('visa_type', self.info.visa_type(), {
                    path: '/'
                });
                $.cookie('purpose', self.info.purpose(), {
                    path: '/'
                });
            ...
            self.checkoutPaypal = function() {
                ...
                var params = {
                    'ItemNumber': self.tracking_id(),
                    'ItemPrice': self.invoice.total()
                };
        ...
        var VisaModelOld = function() {
            ...
            self.fromDate = new Date(2014, 3, 29, 15, 0, 0);
            self.toDate = new Date(2014, 4, 5, 0, 0, 0);
            self.isUrgently = ko.observable(false);
            self.isUrgently.subscribe(function(newValue) {
                self.info.expressType('');
            });
            ...
            self.invoice.service = ko.computed(function() {
                ...
                if (cond) {
                    self.info.is_emb(false);
                    if (self.info.visa_type().substring(0, 1) == '1')
                        return 180 * self.persons().length;
                    else if (self.info.visa_type().substring(0, 1) == '3')
                        return 190 * self.persons().length;
                } else {
                    if (self.isUrgently()) {
                        var result = 0;
                        var index = self.info.arrival_time().indexOf(':');
                        var feeUrgent = rushFee({
            ...
            self.validate.visaTypeMsg = ko.observable('This visa type is not available.');
